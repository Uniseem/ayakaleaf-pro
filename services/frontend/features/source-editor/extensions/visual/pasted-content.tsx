...
/**
 * What was pasted, kept just long enough to offer to paste it differently.
 *
 * Cleared by the first document change: once the writer has carried on typing,
 * the offer is stale, and a menu hanging off an old position would be pointing
