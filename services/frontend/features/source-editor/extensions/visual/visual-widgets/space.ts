...
/**
 * A space of a particular width, for the commands that produce one.
 *
 * Drawn as width rather than as characters: a thin space is three eighteenths
 * of an em, which no number of ordinary spaces is.
 */
...
// The widths TeX gives these, in em.
