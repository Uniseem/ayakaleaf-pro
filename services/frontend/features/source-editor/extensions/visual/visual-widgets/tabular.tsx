...
/**
 * The table a tabular environment is drawn as.
 *
 * React inside a CodeMirror widget, so the root is kept per element and reused
 * across updates: creating a new root on every redraw would remount the whole
 * table and lose whichever cell was being edited.
 */
