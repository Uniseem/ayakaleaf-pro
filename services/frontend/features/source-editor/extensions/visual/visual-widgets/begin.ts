...
/**
 * The name of an environment, in place of its `\begin{...}` line.
 *
 * Subclassed rather than parameterised for the environments that show more
 * than a name -- see BeginTheoremWidget -- which is why buildName is separate.
 */
