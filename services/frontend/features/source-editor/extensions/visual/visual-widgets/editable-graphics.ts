...
/**
 * A graphic with the button that opens the figure modal on it.
 *
 * Only a figure the parser could read all of gets the button: editing one it
 * only partly understood would rewrite the parts it did understand and quietly
 * drop the rest.
 */
