...
/**
 * Shown in place of a table the generator cannot represent.
 *
 * Drawing such a table approximately would be worse than not drawing it: the
 * notice says the table itself is fine and only its preview is missing, which
