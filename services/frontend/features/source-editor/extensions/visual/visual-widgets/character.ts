...
/**
 * A character a command stands for, drawn in its place.
 *
 * Only for commands whose whole effect is one character: those can be shown
 * without losing anything, which is the test everything in the visual editor
 * has to pass.
 */
