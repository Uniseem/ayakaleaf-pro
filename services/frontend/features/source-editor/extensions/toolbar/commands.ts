...
export const ensureEmptyLine = (state: EditorState, range: SelectionRange, direction: 'above' | 'below' = 'below') => {
...
export const addComment = (location: string) => {
  window.dispatchEvent(new CustomEvent('add-new-review-comment', { detail: { location } }))
}
