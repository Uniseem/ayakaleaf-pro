...
export const setOverflowPaddingEffect = StateEffect.define<VerticalPadding>()
...
const bottomPadding = bottomPaddingFacet.computeN([overflowPaddingState, minimumBottomPaddingState], state => {
  return [state.field(minimumBottomPaddingState), state.field(overflowPaddingState).bottom]
})
...
const contentAttributes = EditorView.contentAttributes.compute([bottomPaddingFacet], state => {
...
const topPaddingDecoration = EditorView.decorations.compute([topPaddingFacet], state => {
