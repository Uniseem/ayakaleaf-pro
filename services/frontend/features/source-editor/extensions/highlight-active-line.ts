import { Decoration, DecorationSet, EditorView, layer, LayerMarker, RectangleMarker, ViewPlugin, ViewUpdate } from '@codemirror/view'
...
export const highlightActiveLine = (visual: boolean) => {
  ...
  return sourceOnly(visual, [activeLineLayer, singleLineHighlighter, highlightActiveLineTheme])
}
...
const activeLineLayer = layer({
  ...
  markers(view: EditorView): readonly LayerMarker[] {
    ...
    const coords = fullHeightCoordsAtPos(view, main.head, main.assoc || undefined)
