/**
 * The shape the figure modal walks, and what counts as an image.
 *
 * A tree rather than the flat entry list the project context holds, because
 * the modal shows folders to put a new file in and needs to know what is
 * inside each one.
 */
