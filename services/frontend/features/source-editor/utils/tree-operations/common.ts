...
export const previousSiblingIs = (state: EditorState, pos: number, expectedName: string): boolean | null => {
...
export const getOptionalArgumentText = (state: EditorState, optionalArgumentNode: SyntaxNode): string | undefined => {
...
export const childOfNodeWithType = (node: SyntaxNode, ...types: (string | number)[]): SyntaxNode | null => {
