...
/**
 * The colour a textcolor command names, if it is one we can show.
 *
 * Only xcolor base names. A colour the document defines for itself is not
 * resolved here, and text in it stays unstyled rather than being shown in
 * some other colour.
 */
