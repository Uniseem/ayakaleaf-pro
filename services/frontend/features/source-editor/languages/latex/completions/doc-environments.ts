...
import type { ProjectionResult } from '../../../utils/tree-operations/projection'
import type { Environment } from '../../../utils/tree-operations/environments'
...
export const findEnvironmentsInDoc = (context: CompletionContext) => {
  ...
  const environmentNamesProjection: ProjectionResult<Environment> | undefined = context.state.field(
