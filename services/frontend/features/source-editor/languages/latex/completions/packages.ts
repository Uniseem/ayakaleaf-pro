...
import { applySnippet, extendOverUnpairedClosingBrace, extendRequiredParameter } from './apply'
 ...
 */
export function buildPackageCompletions(completions: Completions, context: CompletionContext) {
