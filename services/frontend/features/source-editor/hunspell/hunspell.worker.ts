...
// Copied out of the package by scripts/copy-hunspell.mjs. Named by URL rather
// than imported: the wasm is fetched by the Emscripten glue at run time, not
// linked into the bundle, and a bundler that inlined it would be shipping a
// megabyte to every page that loads the editor.
const hunspellWasmPath = '/hunspell/hunspell.wasm'
