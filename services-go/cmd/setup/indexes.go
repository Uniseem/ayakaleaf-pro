...
var indexes = []indexSpec{
	...
	{collection: "projectInvites", name: "project_email_unique", keys: bson.D{{Key: "projectId", Value: 1}, {Key: "email", Value: 1}}, unique: true},
	{collection: "projectInvites", name: "token_unique", keys: bson.D{{Key: "token", Value: 1}}, unique: true},
	{collection: "projectInvites", name: "expiresAt_1", keys: bson.D{{Key: "expiresAt", Value: 1}}, expireAfter: 0},
